...
window.onload = function() {
  if (detectMobile()) {
      ...
      message.innerHTML = '<div id="mobile_message">This game is not available on mobile devices. <br> Please visit from a desktop or laptop to play. <br> Visit us! <br> <a id="website_link" href="https://www.aaafreight.net">AAA Freight!</a></div>';
